...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Verify the test data is populated
        self.stdout.write(self.style.SUCCESS('Verifying test data in the database:'))
        ...
        self.stdout.write(f'Leaderboard entries count: {Leaderboard.objects.count()}')
